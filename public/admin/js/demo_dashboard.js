$(function(){
    ...
    Morris.Donut({
        ...
        data: [
            {label: "Approved", value: $('#hidden-approved').val()},
            {label: "Rejected", value: $('#hidden-reject').val()},
            {label: "Pending", value: $('#hidden-pending').val()}
        ],
        colors: ['green', 'red', '#FEA223'],
        resize: true
    });
    ...
    Morris.Line({
        ...
        xkey: 'y',
        ykeys: ['a','b'],
        labels: ['Payments','Event'],
        resize: true,
        hideHover: true,
        xLabels: 'day',
        gridTextSize: '10px',
        lineColors: ['green','#33414E'],
        gridLineColor: '#E5E5E5'
    });
